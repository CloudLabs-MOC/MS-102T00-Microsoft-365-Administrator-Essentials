...
4. In the **Microsoft 365 Defender** portal, select **Show navigation (1)** and then scroll down towards the bottom of the left-hand navigation pane and expand the **System** section a and select **Permissions (2)**.

   ![](../Images/p14t1p1-july26.png)

5. On the **Permissions** page, there are four sections - Microsoft Defender XDR, Microsoft Entra ID, Email & collaboration roles and Cloud Apps. Under the **Email & collaboration roles (1)** section, select **Roles (2)**.

   ![](../Images/p14t1p2-july26.png)

6. In the list of roles that appears, select the **Name** column heading to sort the roles in ascending alphabetical name order. Select the **Compliance Data Administrator (1)** role group.

7. In the **Compliance Data Administrator** pane that appears, note the list of roles that have been assigned to this role group and select **Edit (2)**.

   ![](../Images/p14t1p3-july26.png)

8. In the **Compliance Data Administrator** window, select **Choose users (1)** under the Members pane.

   ![](../Images/p14t1p4-july26.png)

9. In the **Choose users** window, in the search filed type **Lynne (1)** press enter, select the check box next to **Lynne Robbins (2)** and then click on **Select (3)** button.

   ![](../Images/p14t1p5-july26.png)

10. In the **Compliance Data Administrator** window, select **Done**.

    ![](../Images/p14t1p6-july26.png)

11. In the **Warning** pop-up window, select **Confirm**.

    ![](../Images/p14t1p7-july26.png)

12. Select **Compliance Data Administrator** and verify that the **Members** section shows **1 user**, as illustrated in the image below.

    ![](../Images/p14t1p8-july26.png)
