...
>**Note:** Once you launch the track, you’ll have access to a virtual machine (VM) for **40 hours**. The displayed track duration of **30 days** indicates the time frame during which you can use your VM. Please plan your lab sessions accordingly. If the VM uptime of 40 hours is fully exhausted before completing the labs, access will be lost. To avoid this, **once you finish using the lab for the day, please stop or deallocate the VM from the Resources tab**. Refer to the **[Managing Your Virtual Machine](#https://raw.githubusercontent.com/CloudLabs-MOC/MS-102T00-Microsoft-365-Administrator-Essentials/prod-new/Instructions/Labs/Gettingstarted.md#managing-your-virtual-machine)** section for step-by-step instructions.  
