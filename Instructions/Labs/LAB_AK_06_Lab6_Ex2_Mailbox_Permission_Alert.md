# Lab 06 - Exercise 2: Implement Mailbox Permission Alert
...
2. In the **Microsoft 365 Defender** portal, select **Show navigation (1)** and then scroll down to the bottom of the **Email & collaboration (2)** section and select **Policies & rules (3)**.

   ![](../Images/p12t1p2-july26.png)

3. On the **Policies & rules** window, select **Alert policy**.

   ![](../Images/p15t1p1-july26.png)
...
1. In your Edge browser, select the **Microsoft 365 admin center** tab, and then in the left-hand navigation pane, select **Users > Active Users (1)**.

1. From the **Active users** list, search for `Lynne` **(2)** and select for **Lynne Robbins (3)** (not the check box).

   ![](../Images/p15t1p2-july26.png)
...
1. On the **Delegation** tab, there are three mailbox permissions that can be updated: **Send as**, **Send on behalf**, and **Read and manage (Full Access)**. You want to add each of these permissions for Alex's mailbox to **Joni Sherman**. For each permission, perform the following steps to add Joni to that permission:
   ...
   - On the **Manage mailbox delegation** pane, select **+ Add members**.
     ...
     ![](../Images/p15t1p3-july26.png)

   - In the list of users that appears, search for `Joni` **(1)** and select the check box for **Joni Sherman (2)** and then select **Save (3)**.

     ![](../Images/p15t1p4-july26.png)

   - In the **Add delegate permissions?** pane, select **Confirm**.

     ![](../Images/p15t1p5-july26.png)

   - Once the mailbox permission is added to Alex's mailbox, select the back arrow at the top of the pane.

     ![](../Images/p15t1p6-july26.png)
